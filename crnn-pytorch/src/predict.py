...
from dataset import CustomDataset, synth90k_collate_fn
...
def main():
    ...
    num_class = len(CustomDataset.LABEL_TO_CHAR) + 1
    ...
    preds = predict(crnn, predict_loader, CustomDataset.LABEL_TO_CHAR,
